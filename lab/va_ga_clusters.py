...
va_ga_mix = clustering()
va_ga_mix_stochastic = clustering(stochastic_cluster)

plt.plot(va_ga_mix, color='#4169e1', linestyle='solid')
plt.plot(va_ga_mix_stochastic, color='#f2410c', linestyle='dashdot')
plt.show()
