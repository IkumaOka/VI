...
def main():
    ...
    f = open('stochastic_loglikelihoods.csv', 'w')
    ...
    for i in seeds:
        ...
        # csvWriter.writerow(normal_loglikelihoods)
        # print("svi now...")
        # svi_loglikelihoods = svi_clustering(X)
        # csvWriter.writerow(svi_loglikelihoods)
        print("stochastic now...")
        stochastic_loglikelihoods = stochastic_clustering(X)
        csvWriter.writerow(stochastic_loglikelihoods)
    f.close()
